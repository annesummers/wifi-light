...
import com.giganticsheep.nofragmentbase.ui.base.RecyclerViewRelativeLayoutContainer;
 ...
 */
public class GroupContainer extends RecyclerViewRelativeLayoutContainer
    ...
    public GroupContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    protected Screen.ViewInterfaceBase getViewInterface() {
        return this;
    }
    ...
    @Override
    protected ClassLoader getLayoutManagerClassLoader() {
        return GridLayoutManager.class.getClassLoader();
    }
